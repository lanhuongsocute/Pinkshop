                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="product-slick">
                                        ...
                                        @else
                                            ...
                                            <div><img src="{{$photo}}" alt="{{$product->title}}"
                                ...
                                <div class="col-lg-6 rtl-text">
                                    <div class="product-right">
                                        <div class="product-count">
                                            <ul>
                                                <li>
                                                    ...
                                                    <span class="p-counter">{{$product->sold}}</span>
                                                    
                                                </li>
                                                <li>
                                                    <img src="{{asset('frontend/assets/images/person.gif')}}" class="img-fluid user_img"
                                                        alt="image">
                                                   
                                                    <span class="lang">đã xem</span>
                                                    <span class="p-counter">{{$product->hit}}</span>
                                                </li>
                                            </ul>
                                        </div>
                                        <h2>{{$product->title}}</h2>
                                        ...
                                        <h3 class="price-detail"> {{number_format($product->price,0,".",",")}} <del> {{$productdata->old_price?number_format($productdata->old_price,0,'.',','):''}}</del><span>{{$word>0?"giảm ".$word.'%':''}} </span></h3>
                                        ...
                                        <div class="product-buttons">
                                            <a href="javascript:void(0)" id="cartEffect" data-id="{{$product->id}}"
                                                class="btn btn-solid hover-solid btn-animation"><i
                                                    class="fa fa-shopping-cart me-1" aria-hidden="true"></i> Thêm giỏ hàng</a> 
                                            <a href="javascript:void(0)" data-id="{{$product->id}}" id="addWishlist" class="btn btn-solid"><i
                                            ...
                                            <div class="img-wrapper">
                                                <div class="front">
                                                    <a href="{{route('front.product.view',$randpro->slug)}}">
                                                        <img  src="{{count($nphotos)>0?$nphotos[0]:asset('frontend/assets/images/fashion/pro/1.jpg')}}"
                                                            class="img-fluid blur-up lazyload bg-img" alt="{{$randpro->title}}"></a>
                                                </div>
                                                <div class="back">
                                                    <a href="{{route('front.product.view',$randpro->slug)}}">
                                                        <img src="{{count($nphotos)>1?$nphotos[1]:asset('frontend/assets/images/fashion/pro/1.jpg')}}"
                                                            class="img-fluid blur-up lazyload bg-img" alt="{{$randpro->title}}"></a>
                                                </div>
                                                <div class="cart-info cart-wrap">
                                                            <button onclick="openCart()" title="Add to cart"><i
                                                                    class="ti-shopping-cart" data-id="{{ $randpro->id}}"></i></button>
                                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" data-id="{{ $randpro->id}}"
                            ...
                            <div class="offer-slider slide-1">
                                ...
                                <?php
                                    ...
                                    for( ;  $i < 6 && $i < count($newpros);$i ++)
                                    {
                                        ...
                                        ?>
                                            <div class="media">
                                                <a href="{{route('front.product.view',$newpro->slug)}}"><img style="max-width:160px; max-height:160px" class="img-fluid blur-up lazyload"
                                                        src="{{count($nphotos)>0?$nphotos[0]:asset('frontend/assets/images/fashion/pro/1.jpg')}}" alt="{{$newpro->title}}"></a>
                                                <div class="media-body align-self-center">
                                                    <a href="{{route('front.product.view',$newpro->slug)}}">
                                                        <h6>{{$newpro->title}}</h6>
                            ...
                            <div class="offer-slider slide-1">
                                ...
                                <?php
                                    ...
                                    for($i = 0;  $i < 3 && $i < count($poppros);$i ++)
                                    {
                                        ...
                                        ?>
                                            <div class="media">
                                                <a href="{{route('front.product.view',$poppro->slug)}}"><img style="max-width:160px; max-height:160px" class="img-fluid blur-up lazyload"
