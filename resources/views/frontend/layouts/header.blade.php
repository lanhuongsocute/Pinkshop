                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="header-contact">
                            <ul>
                                <li>Chào mừng bạn đến {{$detail->short_name}}</li>
                                <li><i class="fa fa-phone" aria-hidden="true"></i>hot line: {{$detail->hotline}}</li>
                            </ul>
                        </div>
                    </div>
                    <?php
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="main-menu">
                        ...
                        <div>
                            <form method = "GET" action="{{route('front.product.search')}}" class="form_search" role="form">
                                @csrf       
                                ...
                                <div class="icon-nav">
                                    <ul>
                                        ...
                                        <li class="onhover-div mobile-cart">
                                          @include('frontend.layouts.head_shopcart')
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="sidenav fixed-sidebar marketplace-sidebar" style="z-index:1000">
                            <nav>
                                ...
                                <ul id="sub-menu" class="sm pixelstrap sm-vertical">
                                    ...
                                    <li> <a href="{{route('front.product.cat',$cat->slug)}}">{{$cat->title}}</a>
                                    @endforeach
                        ...
                        <div class="main-nav-center">
                            <nav class="text-start">
                                ...
                                <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                                    ...
                                    <li><a href="{{route('front.product.hot' )}}">Sản phẩm hot</a></li>
                                    <li><a href="{{route('front.product.cat','laptop')}}">Laptop</a></li>
                                    <li><a href="{{route('front.product.cat','camera-wifi')}}">Camera</a></li>
                                    <li><a href="{{route('front.chinhsach.view','bang-gia')}}">Bảng giá</a></li>
                                    <li><a href="{{route('front.categories.view' )}}">Tin tức</a></li>
