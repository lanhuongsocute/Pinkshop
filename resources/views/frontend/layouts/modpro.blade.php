            ...
            <div class="row">
                <div class="col-12">
                    <div class="title-basic  " style ="  padding: 0 0 14px 0;  border-bottom: 1px solid #ddd;">
                        <h2 class="title"><i class="ti-bolt"></i> {{$mod_pro->title}}</h2>
                          ...
                          ?>
                            <div class="product-box product-wrap">
                                <div class="img-wrapper">
                                    @if($word > 0)
                                    <div class="lable-block"><span class="lable3">{{  "- ".$word.'%' }}</span>  </div>
                                    @endif
                                    <div class="front">
                                        <a href="{{route('front.product.view',$product->slug)}}"><img
                                                src="{{$photos[0]?$photos[0]:asset('frontend/assets/images/electronics/pro/26.jpg')}}"
                                                class="img-fluid blur-up lazyload bg-img" alt="{{$product->title}}" title="{{$product->title}}"></a>
                                    </div>
                                ...
                                <div class="product-detail">
                                    ...
                                    <a href="{{route('front.product.view',$product->slug)}}">
                                        <p style="font-size:16px">{{$product->title}}</p>
                                    </a>
                                    <h4> <del> {{$product->old_price?number_format($product->old_price,0,".",",") :'' }}</del> 
