             ...
             <form method="post" action="{{route('delivery.update',$delivery->id)}}">
                ...
                <div class="intro-y box p-5">
                    <div>
                        ...
                        <input id="title" name="full_name" type="text" value="{{$delivery->full_name}}" class="form-control" placeholder="tên">
                    </div>
                    ...
                    <div class="mt-3">
                        ...
                        <input id="address" name="address" value="{{$delivery->address}}"  type="text" class="form-control" placeholder="địa chỉ">
                    </div>
