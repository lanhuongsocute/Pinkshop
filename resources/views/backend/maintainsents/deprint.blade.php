                        ...
                        <div class="px-5 py-10 sm:px-20 sm:py-10">
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <div class="text-primary font-semibold text-2xl">PHIẾU GỬI HÀNG BẢO HÀNH</div>
                                    <div class="mt-1"> Mã: <span class="font-medium">{{$ms->id}}</span> </div>
                        ...
                        <div class="px-5 py-10 sm:px-20 sm:py-10">
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <td>
                                        <div class="text-primary font-semibold text-3xl">{{\App\Models\User::find($ms->supplier_id)->full_name}}</div>
                                        <div class="text-primary font-semibold text-2xl">{{\App\Models\User::find($ms->supplier_id)->phone}}</div>
                                        <div class="text-primary font-semibold text-2xl">{{\App\Models\User::find($ms->supplier_id)->address}}</div>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="px-5 py-10 sm:px-20 sm:py-10">
                            <table style="width: 100%">
                                <tr>
                                    <td>
                                        <?php
                                        if($ms->delivery_id != null)
                                        {
                                            $de = \App\Models\User::find($ms->delivery_id);
