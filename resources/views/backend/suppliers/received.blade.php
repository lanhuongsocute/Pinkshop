...
<div class="content">
    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                    <h2 class="text-lg font-medium mr-auto">
                        Nhận tiền từ nhà cung cấp: {{\App\Models\User::where('id',$supplier->id)->value('full_name')}}
                    </h2>
    ...
    <div class="grid grid-cols-12 gap-12 mt-5">
        <div class="intro-y col-span-12 lg:col-span-12">
            <!-- BEGIN: Form Layout -->
            <form method="post" action="{{route('supplier.storereceived')}}">
                @csrf
                <div class="intro-y box p-5">
                    <div>
                        ...
                        <?php
                            ...
                            else
                            {
                                ...
                                $text_c="Nhà cung cấp còn nợ tiền";
                            }
                            ?>
                         <div class="{{ $classname}}"> 
                    ...
                    <div>
                        ...
                        value = "{{$supplier->budget<0?-$supplier->budget : $supplier->budget}}"
