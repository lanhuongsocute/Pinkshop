...
@include('backend.layouts.notification')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{route('supplier.create')}}" class="btn btn-primary shadow-md mr-2">Thêm nhà cung cấp</a>
            
            <div class="hidden md:block mx-auto text-slate-500">Hiển thị trang {{$suppliers->currentPage()}} trong {{$suppliers->lastPage()}} trang</div>
        ...
        <div   class=" intro-y col-span-12 flex flex-col sm:flex-row sm:items-end xl:items-start">
            <form action="{{route('supplier.sort')}}" method = "get" class="xl:flex sm:mr-auto" >
                <!-- @csrf -->
                            ...
                            <div class="dropdown py-3 px-1 ">  
                                ...
                                <div class="dropdown-menu w-40"> 
                                    <ul class="dropdown-content">
                                        ...
                                        <li><a class="dropdown-item"  href="{{route('user.storetouser',$item->id)}}"  class="flex items-center mr-3" href="javascript:;"> <i data-lucide="corner-up-right" class="w-4 h-4 mr-1"></i>  Trả tiền NCC</a></li>
                                        <li><a class="dropdown-item"  href="{{route('supplier.productdetails',$item->id)}}"  class="flex items-center mr-3" href="javascript:;"> <i data-lucide="paperclip" class="w-4 h-4 mr-1"></i> Xem sản phẩm mua </a></li>
