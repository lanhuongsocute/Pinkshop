...
@include('backend.layouts.notification')
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">
            Cập nhật phiếu nhận bảo hành
        </h2>
    </div>
    <div class="grid grid-cols-12 gap-12 mt-5">
        <div class="intro-y col-span-12 lg:col-span-12">
            <!-- BEGIN: Form Layout -->
            <form method="post" action="{{route('maintainin.update',$maintainin->id)}}">
                @csrf
                @method('patch')
                <div class="intro-y box p-5">
                    <div class=" mt-3 ">
                                ...
                                <div class="flex">
                                    <input type="text" id='customer_search'  value="{{\App\Models\User::find($maintainin->customer_id)->full_name}}"
                    ...
                    <div class="mt-3">
                        ...
                        <input id="shipcost" name="shipcost"  value="{{$ship_amount}}"
