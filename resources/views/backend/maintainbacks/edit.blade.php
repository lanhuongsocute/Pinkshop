...
<div class="content">
                <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                    <h2 class="text-lg font-medium mr-auto">
                        Điều chỉnh phiếu trả bảo hành từ đối tác
                    </h2>
                    ...
                    <div class="col-span-12 lg:col-span-4">
                        <div class="intro-y box mt-3  py-3 px-3 ">
                            ...
                            <label style="min-width:50px  " class="form-select-label" for="">
                                ...
                                <div class="flex">
                                    <input type="text" id='supplier_search' value="{{\App\Models\User::find($mb->supplier_id)->full_name}}"
                                ...
                                <input type="hidden" id="supplier_id" value="{{$mb->supplier_id}}" />
                        ...
                        <div class="intro-y box mt-3  py-3 px-3 ">
                            <div class="mt-3 ">
                                ...
                                <input type="number" id='shipcost'  value="{{$mb->shipcost}}"
...
$(document).ready(function(){ //Your code here 
    ...
    $.ajax({
        type: 'GET',
        url: '{{route("maintainback.getProductList")}}',
        data: {
            mb_id: {{$mb->id}},
        ...
        success: function(data) {
            ...
            products.forEach((pitem) => {
                ...
                newpro = new Product(pitem.id,pitem.title, pitem.price,pitem.quantity,imageurls[0],pitem.seri);
                flag = 0;
...
$('#btnstore').on( "click", function() {
    ...
    importDoc = new ImportDoc({{$mb->id}},supplier_id,final_amount,0, shipcost,paid_amount, bank_id);
    ...
    $.ajax({
        url: "{{route('maintainback.update',$mb->id)}}", // Replace with your actual server endpoint URL
        method: "POST",
