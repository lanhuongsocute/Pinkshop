                        ...
                        <div class="px-5 py-10 sm:px-20 sm:py-10">
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <div class="text-primary font-semibold text-3xl">PHIẾU TRẢ BẢO HÀNH</div>
                                    <div class="mt-2"> Mã: <span class="font-medium">{{$mb->id}}</span> </div>
                                    <div class="mt-1">Ngày lập: {{$mb->created_at}}</div>
                                    <div class="form-help">
                                        {{$mb->created_at!=$mb->updated_at?"Điều chỉnh: ".$mb->updated_at:""}}
                                       <br/>
                                    ...
                                    <td style="width: 50%" class="text-left">
                                        <div >
                                            ...
                                            <div class="text-lg font-medium text-primary mt-2">
                                                {{\App\Models\User::where('id',$mb->supplier_id)->value('full_name')}}
                                            </div>
                                            <div class="mt-1">{{\App\Models\User::where('id',$mb->supplier_id)->value('phone')}}</div>
                                            <div class="mt-1">{{\App\Models\User::where('id',$mb->supplier_id)->value('address')}}</div>
                                        </div>
                                    </td>
                                    <td class="text-right">
                                        <div >
                                            ...
                                            <div class="text-lg font-medium text-primary mt-2">
                                                {{\App\Models\User::where('id',$mb->vendor_id)->value('full_name')}}
                                            </div>
                                            <div class="mt-1">{{\App\Models\User::where('id',$mb->vendor_id)->value('phone')}}</div>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="border-b-2 dark:border-darkmode-400 whitespace-nowrap">Đơn giá</th>
                                ...
                                <tfooter>
                                    <tr>
                                        ...
                                        <td class="text-right font-medium">
                                            {{number_format($mb->final_amount, 0, '.', ',')}}
                                        </td>
                                    </tr>
                                </tfooter>
                            </table>
