...
<div class="content">
    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                    <h2 class="text-lg font-medium mr-auto">
                        Thanh toán phiếu bảo hành của: {{\App\Models\User::where('id',$mb->supplier_id)->value('full_name')}}
                    </h2>
