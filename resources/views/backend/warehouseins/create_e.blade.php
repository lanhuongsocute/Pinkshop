                    ...
                    <div class="col-span-12 lg:col-span-4">
                        <div class="intro-y box mt-3  py-3 px-3 ">
                            ...
                            <div class=" mt-3 ">
                                ...
                                <div class="flex">
                                    <input type="text" id='supplier_search' value="{{$supplier->full_name}}"
                        ...
                        <div class="intro-y box mt-3  py-3 px-3">
                            ...
                            <div class="mt-3"> 
                                ...
                                <input type="number" id='discount_amount'  value="{{$discount_amount}}"
                            ...
                            <div class="mt-3">
                                ...
                                <input  id='paid_amount' type="number" name='paid_amount' value="{{$paid_amount}}"
                                class="form-control py-3 mt-2 " placeholder="số tiền đã thanh toán">
                                <input type='hidden' value='{{$final_amount}}' id='totalcost'/>
                            </div>
                            <div class="mt-3">
                                <label style="min-width:50px  " class="form-select-label" for="">
...
$('#btnstore').on( "click", function() {
    ...
    $.ajax({
        url: "{{route('warehousein.store')}}", // Replace with your actual server endpoint URL
        method: "POST",
