                        ...
                        <div class="px-1 py-2 sm:px-1 sm:py-2">
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <div class="form-help">
                                        {{$warehousein->created_at!=$warehousein->updated_at?"Điều chỉnh: ".$warehousein->updated_at:""}}
                                       <br/>
                                       <span class="font-medium text-danger"> {{$warehousein->status=='returned'?'ĐÃ TRẢ HÀNG':''}}
                                        </span>
