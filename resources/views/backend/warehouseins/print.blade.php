...
<div id="divToPrint" class="intro-y flex flex-col sm:flex-row items-center mt-8">
                
                <div class="intro-y box overflow-hidden mt-5">
                    <div class="border-b border-slate-200/60 dark:border-darkmode-400 text-center sm:text-left">
                        <div class="px-5 py-10 sm:px-20 sm:py-20">
                            <div class="text-primary font-semibold text-3xl">HÓA ĐƠN NHẬP</div>
                            <div class="mt-2"> Mã <span class="font-medium">#1923195</span> </div>
