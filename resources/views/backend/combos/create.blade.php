...
$('#btnstore').on( "click", function() {
    ...
    importDoc = new ImportDoc(0,product_id,final_amount,quantity );
    ...
    $.ajax({
        url: "{{route('combo.store')}}", // Replace with your actual server endpoint URL
        method: "POST",
 ...
 ////////////////////////////////////////////////
  ...
  ////////////////////////////////////////////////
    ...
    product_search.autocomplete({
        ...
        select: function(event, ui) { 
            console.log(ui.item);
            var newProduct = new Product(ui.item.id,ui.item.value, ui.item.price,ui.item.imgurl,ui.item.qty );
