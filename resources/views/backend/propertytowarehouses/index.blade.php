...
@include('backend.layouts.notification')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{route('propertytowarehouse.create')}}" class="btn btn-primary shadow-md mr-2">Thêm </a>
            
            <div class="hidden md:block mx-auto text-slate-500">Hiển thị trang {{$ptws->currentPage()}} trong {{$ptws->lastPage()}} trang</div>
                            ...
                            <div class="dropdown py-3 px-1 ">  
                                ...
                                <div class="dropdown-menu w-40"> 
                                    <ul class="dropdown-content">
                                        ...
                                        <li><a href="{{route('propertytowarehouse.edit',$item->id)}}" class="dropdown-item flex items-center mr-3" href="javascript:;"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit </a></li>
                                        <li> 
                                            <form action="{{route('propertytowarehouse.destroy',$item->id)}}" method = "post">
                                            @csrf
                                            @method('delete')
    ...
    <!-- END: HTML Table Data -->
        ...
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-row sm:flex-nowrap items-center">
            <nav class="w-full sm:w-auto sm:mr-auto">
                {{$ptws->links('vendor.pagination.tailwind')}}
            </nav>
