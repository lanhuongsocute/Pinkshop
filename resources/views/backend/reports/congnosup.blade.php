                                ...
                                <table id="myTable" class="display table" style="width:100%">
                                    ...
                                    @if ($debt->id != null)
                                        <tr>
                                            ...
                                            <td > {{number_format($debt->tongnhap,0,".",",")}} </td>
                                            <td class ="{{$debt->tongln < 0? 'text-danger':''}}"> {{number_format($debt->tongban,0,".",",")}} </td>
                                            <td> {{number_format($debt->loinhuan,0,".",",")}} </td>
                                            <td> {{$debt->phone}} </td>
                                            <td> {{$debt->address}} </td>
                                        </tr>
                                    @endif
