                        ...
                        <div class="grid grid-cols-12 gap-6 mt-8">
                            ...
                            <div class="col-span-12 ">
                                ...
                                <div   class=" intro-y col-span-12 flex flex-col sm:flex-row sm:items-end xl:items-start">
                                    <form action="{{route('report.thuchi')}}" method = "get" class="xl:flex sm:mr-auto" >
                                        <!-- @csrf -->
                                    ...
                                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                        <div class="report-box zoom-in">
                                            <div class="box p-5">
                                                ...
                                                <div class="text-3xl font-medium leading-8 mt-6">{{Number_format($tongthuchi,0,'.',',')}}</div>
                                    ...
                                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                        <div class="report-box zoom-in">
                                            <div class="box p-5">
                                                ...
                                                <div class="text-3xl font-medium leading-8 mt-6">{{Number_format($tongbanhang,0,'.',',')}}</div>
                                    ...
                                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                        <div class="report-box zoom-in">
                                            <div class="box p-5">
                                                ...
                                                <div class="text-3xl font-medium leading-8 mt-6">{{Number_format($tongnhaphang,0,'.',',')}}</div>
                                    ...
                                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                        <div class="report-box zoom-in">
                                            <div class="box p-5">
                                                ...
                                                <div class="text-3xl font-medium leading-8 mt-6">{{Number_format($tongbanhang-$tongnhaphang+$tongthuchi,0,'.',',')}}</div>
...
function drawChart( ) {
        ...
        var i = 0;
        @foreach ( $thuloais as $adetail)
            var sx = new Array();
            sx.push("" + '{{$adetail->typetitle}}');
            sx.push({{$adetail->thu}}*1);
            f_data1.push(sx);
        @endforeach
        ...
        f_data2.push(sx);
        i = 0;
        @foreach ( $chiloais as $adetail)
            sx = new Array();
            sx.push("" + '{{$adetail->typetitle}}');
            sx.push({{$adetail->chi}}*1);
            f_data2.push(sx);
        @endforeach
        ...
        f_data4.push(sx);
        i = 0;
        @foreach ( $thungays as $adetail)
            sx = new Array();
            sx.push("" + '{{$adetail->ngay}}');
            sx.push({{$adetail->tongthu}}*1);
            f_data4.push(sx);
        @endforeach 
        ...
        f_data5.push(sx);
        i = 0;
        @foreach ( $chingays as $adetail)
            sx = new Array();
            sx.push("" + '{{$adetail->ngay}}');
            sx.push({{$adetail->tongchi}}*1);
            f_data5.push(sx);
        @endforeach 
