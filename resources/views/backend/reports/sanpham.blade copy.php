                        ...
                        <div class="col-span-12 lg:col-span-12">
                                ...
                                <table class="table">
                                    <thead class="table-dark">
                                        <tr> <td> STT </td><td> Tên </td><td> tổng nhập </td><td> Tổng xuất </td>
...
$("#btnprint").on("click", function(){
        ...
        + '<body onload="window.print()"><div style="min-height:50px !important; margin-left: 0px !important; margin-left:-50px !important;margin-right:-50px !important;" class="content2">'+divToPrint.innerHTML+'</div></body>');
