...
@include('backend.layouts.notification')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{route('binventory.create')}}" class="btn btn-primary shadow-md mr-2">Thêm </a>
            
            <div class="hidden md:block mx-auto text-slate-500">Hiển thị trang {{$binventorys->currentPage()}} trong {{$binventorys->lastPage()}} trang</div>
            <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                <div class="w-56 relative text-slate-500">
                    <form action="{{route('binventory.search')}}" method = "get">
                        @csrf
        ...
        <div   class=" intro-y col-span-12 flex flex-col sm:flex-row sm:items-end xl:items-start">
            <form action="{{route('binventory.sort')}}" method = "get" class="xl:flex sm:mr-auto" >
                <!-- @csrf -->
                    ...
                    <tr class="intro-x">
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                <a href="{{route('binventory.edit',$item->id)}}" class="flex items-center mr-3" href="javascript:;"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
    ...
    <!-- END: HTML Table Data -->
        ...
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-row sm:flex-nowrap items-center">
            <nav class="w-full sm:w-auto sm:mr-auto">
                {{$binventorys->links('vendor.pagination.tailwind')}}
            </nav>
