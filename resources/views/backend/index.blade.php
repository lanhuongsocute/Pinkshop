                        ...
                        <div class="grid grid-cols-12 gap-6 mt-8">
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-5">
                                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                        <div class="report-box zoom-in">
                                            <a href="{{route('bankaccount.index')}}" title="Xem chi tiết">
                                                <div class="box p-5">
                                                    <div class="flex">
                                                    ...
                                                    <div class="text-3xl font-medium leading-8 mt-6">{{Number_format($cash,0,'.',',')}}</div>
                                    ...
                                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                        <div class="report-box zoom-in">
                                            <a href="{{route('warehouseout.today')}}" title="Xem chi tiết">
                                                <div class="box p-5">
                                                    <div class="flex">
                                                    ...
                                                    <div class="text-3xl font-medium leading-8 mt-6">{{Number_format($total_order,0,'.',',')}} / {{Number_format($number_order,0,'.',',')}}</div>
                                        ...
                                        <div class="report-box zoom-in">
                                            <a href="{{route('warehouseout.today')}}" title="Xem chi tiết">
                                                <div class="box p-5">
                                                    ...
                                                    <div class="text-3xl font-medium leading-8 mt-6">{{Number_format($total_return,0,'.',',')}} / {{Number_format($number_return,0,'.',',')}}</div>
                                                    <div class="text-base text-danger text-slate-500 mt-1">Tổng trả / Số đơn trả</div>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                        <div class="report-box zoom-in">
                                        <a href="{{route('inventory.index')}}" title="Xem chi tiết tồn kho">
                                                <div class="box p-5">
                                                    <div class="flex">
                                                    ...
                                                    <div class="text-3xl font-medium leading-8 mt-6">{{Number_format($stock_value,0,'.',',')}}</div>
                                    ...
                                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                        <div class="report-box zoom-in">
                                            <a href="{{route('customer.index')}}" title="danh sách khách hàng">
                                                <div class="box p-5">
                                                    <div class="flex">
                                                    ...
                                                    <div class="text-3xl font-medium leading-8 mt-6">{{Number_format($usernumber,0,'.',',')}}</div>
                            ...
                            <div class="col-span-12 lg:col-span-12  ">
                                ...
                                <div class="intro-y box p-5 mt-12 sm:mt-5">
                                    <div class="flex flex-col md:flex-row md:items-center">
                                        <div class="flex">
                                            <div>
                                                <div class="text-primary dark:text-slate-300 text-lg xl:text-xl font-medium">{{Number_format($sum1,0,'.',',')}}</div>
                                                <div class="mt-0.5 text-slate-500">Tháng này</div>
                                            </div>
                                            <div class="w-px h-12 border border-r border-dashed border-slate-200 dark:border-darkmode-300 mx-4 xl:mx-5"></div>
                                            <div>
                                                <div class="text-slate-500 text-lg xl:text-xl font-medium">{{Number_format($sum2,0,'.',',')}}</div>
                            ...
                            <div class="col-span-12 lg:col-span-12">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        <td> 
                                            <a href="{{route('inventory.viewproduct',$pro->id)}}">
                                                {{$pro->title}}
                                            </a> 
                                        </td>
                                        <td> {{$pro->tongnhap}} </td>
                            ...
                            <div class="col-span-12 lg:col-span-12">
                                ...
                                <table class="table">
                                    ...
                                    @foreach ($outproducts as $pro )
                                    <tr>
                                        <td> <a href="{{route('inventory.viewproduct',$pro->id)}}"> {{$pro->title}} </a></td>
                                        <td> {{$pro->tongban}} </td>
                                        <td> {{$pro->stock}} </td>
                            ...
                            <div class="col-span-12 lg:col-span-12">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        <td> <a  href="{{route('user.showsup',$debt->id)}}" > {{$debt->full_name}} </a></td>
                                        <td> {{$debt->phone}} </td>
                                        <td> {{number_format($debt->budget,0,",",".")}} </td>
                                        <td> 
                                            <?php
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    ...
    {
        var url = "{{route("admin.getoutday")}}";
        load_data_time(url);
    }
    function load_data_month()
    {
        var url = "{{route("admin.getoutmonth")}}";
        load_data_time(url);   
    }
    function load_data_year()
    {
        var url = "{{route("admin.getoutyear")}}";
        load_data_time(url);   
    }
    function load_data_all()
    {
        var url = "{{route("admin.getoutall")}}";
        load_data_time(url);   
    }
