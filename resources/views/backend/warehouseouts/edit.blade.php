                    ...
                    <div class="col-span-12 lg:col-span-4">
                        <div class="intro-y box mt-3  py-3 px-3 ">
                            ...
                            <div class=" mt-3 ">
                                ...
                                <div class="flex">
                                    <input type="text" id='customer_search' value="{{\App\Models\User::where('id',$warehouseout->customer_id)->value('full_name')}}"
...
<script src="{{asset('backend/assets/js/product_selling5.js')}}"></script> 
...
$('#btnstore').on( "click", function() {
    ...
    $.ajax({
        url: "{{route('warehouseout.update',$warehouseout->id)}}", // Replace with your actual server endpoint URL
        method: "POST",
