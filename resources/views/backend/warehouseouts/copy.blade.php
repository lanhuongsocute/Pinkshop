                    ...
                    <div class="col-span-12 lg:col-span-4">
                        ...
                        <div class="intro-y box mt-3  py-3 px-3">
                            ...
                            <div class="mt-3">
                                ...
                                value="{{$warehouseout->paid_amount}}"
...
<script src="{{asset('backend/assets/js/product_selling3.js')}}"></script> 
...
$(document).ready(function(){ //Your code here 
    $.ajax({
        type: 'GET',
        url: '{{route("warehouseout.getOldProductList")}}',
        data: {
        ...
        success: function(data) {
            ...
            products.forEach((pitem) => {
                ...
                newpro = new Product(pitem.id,pitem.title, pitem.price,pitem.type,pitem.quantity,pitem.stock_qty  ,imageurls[0],'',pitem.series,plist);
...
$('#btnstore').on( "click", function() {
    ...
    $.ajax({
        url: "{{route('warehouseout.store',$warehouseout->id)}}", // Replace with your actual server endpoint URL
        method: "POST",
