                        ...
                        <div class="px-5 py-10 sm:px-20 sm:py-10">
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <div class="mt-1"> Mã: <span class="font-medium">{{$warehouseout->id}}</span> </div>
                        ...
                        <div class="px-5 py-10 sm:px-20 sm:py-10">
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <td>
                                        <div class="text-primary font-semibold text-3xl">{{\App\Models\User::find($warehouseout->customer_id)->full_name}}</div>
                                        <div class="text-primary font-semibold text-2xl">{{\App\Models\User::find($warehouseout->customer_id)->phone}}</div>
                                        <div class="text-primary font-semibold text-2xl">{{\App\Models\User::find($warehouseout->customer_id)->address}}</div>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="px-5 py-10 sm:px-20 sm:py-10">
                            <table style="width: 100%">
                                <tr>
                                    <td>
                                        <?php
                                        if($warehouseout->delivery_id != null)
                                        {
                                            $de = \App\Models\User::find($warehouseout->delivery_id);
