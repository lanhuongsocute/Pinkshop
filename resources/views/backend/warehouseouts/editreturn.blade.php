...
$(document).ready(function(){ //Your code here 
    $.ajax({
        type: 'GET',
        url: '{{route("warehouseout.getProductListReturn")}}',
        data: {
            wo_id: {{$warehouseout->id}},
            woold_id: {{$warehouseoutreturn->id}},
...
$('#btnstore').on( "click", function() {
    ...
    $.ajax({
        url: "{{route('warehouseout.updatereturndetail',$warehouseout->id)}}", // Replace with your actual server endpoint URL
        method: "POST",
