                                ...
                                <div class="mt-3">
                                    ...
                                    <select id="warehouse_id" name="wh_id" class="form-select mt-2 sm:mr-2"    >
                                        @foreach ($warehouses as $wh)
                                            <option value="{{$wh->id}}" {{old('wh_id')==$wh->id?'selected':''}}>{{$wh->title}}</option>
                                        @endforeach
                                    </select>
                                </div>
...
<script src="{{asset('backend/assets/js/product_combocreation.js')}}"></script> 
...
$('#btnstore').on( "click", function() {
    ...
    $.ajax({
        url: "{{route('combocreation.store')}}", // Replace with your actual server endpoint URL
        method: "POST",
