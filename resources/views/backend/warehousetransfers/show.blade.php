                        ...
                        <div class="px-5 py-10 sm:px-20 sm:py-10">
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <div class="text-primary font-semibold text-3xl">PHIẾU CHUYỂN KHO</div>
                                    <div class="mt-2"> Mã: <span class="font-medium">{{$warehousetrans->id}}</span> </div>
                            ...
                            <table style="width: 100%">
                                <tr>
                                    <td style="width: 50%" class="text-left">
                                        <div >
                                            <div class="text-base text-slate-500">Kho nguồn</div>
                                            <div class="text-lg font-medium text-primary mt-2">
                                                {{\App\Models\Warehouse::where('id',$warehousetrans->wh_id1)->value('title')}}
                                            </div>
                                            <div class="mt-1">{{\App\Models\User::where('id',$warehousetrans->vendor_id1)->value('full_name')}}</div>
                                            <div class="mt-1">{{\App\Models\User::where('id',$warehousetrans->vendor_id1)->value('phone')}}</div>
                                        </div>
                                    </td>
                                    <td class="text-right">
                                        <div >
                                            <div class="text-base text-slate-500">Kho đích</div>
                                            <div class="text-lg font-medium text-primary mt-2">
                                                {{\App\Models\Warehouse::where('id',$warehousetrans->wh_id2)->value('title')}}
                                            </div>
                                            <div class="mt-1">{{\App\Models\User::where('id',$warehousetrans->vendor_id2)->value('full_name')}}</div>
                                            <div class="mt-1">{{\App\Models\User::where('id',$warehousetrans->vendor_id2)->value('phone')}}</div>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tfooter>
                                    <tr>
                                        ...
                                        <td class="text-right font-medium">
                                            {{number_format($warehousetrans->total, 0, '.', ',')}}
                                        </td>
                                    </tr>
                                </tfooter>
                            </table>
