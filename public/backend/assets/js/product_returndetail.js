...
class Product {
    ...
    generateHTML()
    {
        ...
        + this.name+'</a> <br/><span class="form-help px-2"> Số lượng đã xuất: '+ tonkho+'</span></div> </div> </td> <td class="text-right"><div class="flex"><input type="number" style="width:150px" id="ip'
