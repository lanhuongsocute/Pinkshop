class ImportDoc {
    constructor(id, product_id, final_amount,quantity ) {
    this.id = id;
      this.product_id = product_id;
      this.pricein = final_amount;
...
class Product {
    constructor(id,name, price, url , quantity ) {
        this.id = id;
      this.name = name;
      this.url = url;
      this.price = price;
    ...
    generateHTML()
    {
        ...
        +'<tr style="display:none"> <td  colspan="5"><span> Seri: </span> <input id="seri' 
