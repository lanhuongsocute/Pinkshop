...
$('#btnstore').on( "click", function() {
    ...
    importDoc = new ImportDoc(0,product_id,final_amount );
    ...
    $.ajax({
        url: "<?php echo e(route('combo.store')); ?>", // Replace with your actual server endpoint URL
        method: "POST",
  ...
  ////////////////////////////////////////////////
    ...
    product_search.autocomplete({
        ...
        select: function(event, ui) { 
            ...
            //         });
            //         const newProduct = 
            //         new Product(ui.item.id,ui.item.value, ui.item.price,ui.item.type, 1 );
            //         if(!addtoProductList(newProduct))
            //         {
            //             Swal.fire(
            //                 'Không thực hiện!',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\shop4\resources\views/backend/combos/create.blade.php ENDPATH**/ ?>