                        ...
                        <div class="px-1 py-2 sm:px-1 sm:py-2">
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <div class="text-primary font-semibold text-2xl">PHIẾU NHẬP KHO</div>
                                    <div class="mt-2"> Mã: <span class="font-medium"><?php echo e($warehousein->code); ?></span> </div>
                                    <div class="mt-1">Ngày lập: <?php echo e($warehousein->created_at); ?></div>
                                    <div class="form-help">
                                        <?php echo e($warehousein->created_at!=$warehousein->updated_at?"Điều chỉnh: ".$warehousein->updated_at:""); ?>

                                       <br/>
                                       <span class="font-medium text-danger"> <?php echo e($warehousein->status=='returned'?'ĐÃ TRẢ HÀNG':''); ?>
                                    ...
                                    <div >
                                        <div class="text-base text-slate-500">Nhà cung cấp</div>
                                            <div class="text-lg font-medium text-primary mt-2">
                                                <a  href="<?php echo e(route('user.showsup',$warehousein->supplier_id)); ?>" >
                                                    <?php echo e(\App\Models\User::where('id',$warehousein->supplier_id)->value('full_name')); ?>

                                                </a>
                                            </div>
                                            <div class="mt-1"><?php echo e(\App\Models\User::where('id',$warehousein->supplier_id)->value('phone')); ?></div>
                                            <div class="mt-1"><?php echo e(\App\Models\User::where('id',$warehousein->supplier_id)->value('address')); ?></div>
                                        </div>
                                    </td>
                                    <td class="text-right">
                                    <div  >
                                        ...
                                        <div class="text-lg font-medium text-primary mt-2">
                                        <?php echo e(\App\Models\Warehouse::where('id',$warehousein->wh_id)->value('title')); ?>

                                        </div>
                                        <div class="mt-1"><?php echo e(\App\Models\User::where('id',$warehousein->vendor_id)->value('full_name')); ?>
                    ...
                    <div class="px-1 py-2 sm:px-1 sm:py-2">
                        <div class="overflow-x-auto">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th style="padding:2px !important; padding-top:6px !important; padding-bottom:6px !important; "   > &nbsp;&nbsp; # &nbsp;&nbsp; </th>
                                        ...
                                        <th style="padding:2px !important; padding-top:6px !important; padding-bottom:6px !important; "  class="border-b-2 dark:border-darkmode-400 text-right ">Số<br/>lượng</th>
                                ...
                                <tbody>
                                    <?php $i = 1;?>
                                    <?php $__currentLoopData = $wi_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td style="padding:2px !important; padding-top:6px !important; padding-bottom:6px !important; "  class="border-b dark:border-darkmode-400">
                                            <div class="  ">
                                                <a  href="<?php echo e(route('inventory.viewproduct',$wi->product_id)); ?>" > 
                                                    <?php echo e(\App\Models\Product::where('id', $wi->product_id)->value('title')); ?>
                                    ...
                                    <tr>
                                        <td style="padding:2px !important; padding-top:6px !important; padding-bottom:6px !important; "  colspan="2">
                                            <span class="font-medium "> 
                                                Giảm giá:  <?php echo e(number_format($warehousein->discount_amount, 0, '.', ',')); ?>
                                        ...
                                        <td style="padding:2px !important; padding-top:6px !important; padding-bottom:6px !important; "  class="text-right font-medium">
                                            <?php echo e(number_format($warehousein->final_amount, 0, '.', ',')); ?>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\shop4\resources\views/backend/warehouseins/show.blade.php ENDPATH**/ ?>