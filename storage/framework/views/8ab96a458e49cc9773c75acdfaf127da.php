                        ...
                        <div class="grid grid-cols-12 gap-6 mt-8">
                            ...
                            <div class="col-span-12 row">
                                ...
                                <div   class=" intro-y col-span-12 flex flex-col sm:flex-row sm:items-end xl:items-start">
                                    <form action="<?php echo e(route('report.money')); ?>" method = "get" class="xl:flex sm:mr-auto" >
                                        <!-- <?php echo csrf_field(); ?> -->
                                    ...
                                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                        <div class="report-box zoom-in">
                                            <div class="box p-5">
                                                ...
                                                <div class="text-3xl font-medium leading-8 mt-6"><?php echo e(Number_format($tongloinhuan,0,'.',',')); ?></div>
                                    ...
                                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                        <div class="report-box zoom-in">
                                            <div class="box p-5">
                                                ...
                                                <div class="text-3xl font-medium leading-8 mt-6"><?php echo e(Number_format($tongdoanhthu,0,'.',',')); ?>  </div>
                                    ...
                                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                        <div class="report-box zoom-in">
                                            <div class="box p-5">
                                                ...
                                                <div class="text-3xl font-medium leading-8 mt-6"><?php echo e(Number_format($thuchi,0,'.',',')); ?>  </div>
                                    ...
                                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                        <div class="report-box zoom-in">
                                            <div class="box p-5">
                                                ...
                                                <div class="text-3xl font-medium leading-8 mt-6"><?php echo e(Number_format($tongloinhuan+ $thuchi,0,'.',',')); ?>  </div>
                                        ...
                                        <table id="myTable" class="display table" style="width:100%; ">
                                            ...
                                            <?php if($item->product_id != null): ?>
                                                <tr>
                                                    ...
                                                    <td><span  > <?php echo e(number_format($item->quantity,0,".",",")); ?> </span> </td>
                                                    <td><span  > <?php echo e(number_format($item->tongloinhuan,0,".",",")); ?> </span> </td>
...
function drawChart( ) {
        ...
        var i = 0;
            ...
            <?php $__currentLoopData = $reportdetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $adetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 
                var sx = new Array();
                sx.push("" + '<?php echo e($adetail->ngay); ?>');
                sx.push(<?php echo e($adetail->tongbansp); ?>*1);
                sx.push(<?php echo e($adetail->loinhuan); ?>*1);
                f_data1.push(sx);
        ...
        i = 0;
            ...
            <?php $__currentLoopData = $reportsodons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $adetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 
                sx = new Array();
                sx.push("" + '<?php echo e($adetail->ngay); ?>');
                sx.push(<?php echo e($adetail->sodon); ?>*1);
                f_data2.push(sx);
        ...
        i = 0;
            ...
            <?php $__currentLoopData = $reportthuchis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $adetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\shop4\resources\views/backend/reports/benefit.blade.php ENDPATH**/ ?>