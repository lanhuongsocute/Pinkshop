                            ...
                            <div class="dropdown py-3 px-1 ">  
                                ...
                                <div class="dropdown-menu w-40"> 
                                    <ul class="dropdown-content">
                                        ...
                                        <?php if($item->status == 'active'||$item->status == 'returned'): ?>
                                        ...
                                        <?php if($item->status == 'active'): ?>
                                            ...
                                            <li> 
                                                <form action="<?php echo e(route('warehouseout.returndetail' )); ?>" method = "get">
                                                    <?php echo csrf_field(); ?>
                                                    <input type="hidden" name="id" value = "<?php echo e($item->id); ?>"/>
                                        ...
                                        <?php if($item->status == 'returned'): ?>
                                        <li> 
                                            <form action="<?php echo e(route('warehouseout.warehouseoutDestroyReturndetail')); ?>" method = "post">
                                                <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\shop4\resources\views/backend/warehouseouts/index.blade.php ENDPATH**/ ?>