                                        ...
                                        <div class="report-box zoom-in">
                                            <a href="<?php echo e(route('warehouseout.today')); ?>" title="Xem chi tiết">
                                                <div class="box p-5">
                                                    ...
                                                    <div class="text-3xl font-medium leading-8 mt-6"><?php echo e(Number_format($total_return,0,'.',',')); ?> / <?php echo e(Number_format($number_return,0,'.',',')); ?></div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Workspace\KhoaLuan_2024\shop\resources\views/backend/index.blade.php ENDPATH**/ ?>