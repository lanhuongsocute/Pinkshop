...
<div class="content">
                ...
                <div class="intro-y grid grid-cols-12 gap-5 mt-5">
                    ...
                    <div class="col-span-12 lg:col-span-4">
                            ...
                            <div class="intro-y box mt-3  py-3 px-3 ">
                            <h2> Sản phẩm tạo combo </h2>
                                <div class="lg:flex intro-y">
                               
                                    <div class="relative">
                                        <label> Tìm tên combo </label>
                                        <input type="text" id='compro_search' class="form-control py-3 px-4 w-full   box pr-10" placeholder="Tên sản phẩm ...">
                                        <i class="w-4 h-4 absolute my-auto inset-y-0 mr-3 right-0 text-slate-500" data-lucide="search"></i> 
                                    </div>
                                ...
                                <div class="lg:flex intro-y" id="product_combo"> </div>
                             
                                <div class="relative">
                                        <label> Số lượng</label>
                                        <input type="number" id='quantity' class="form-control py-3 px-4 w-full lg:w-64 box pr-10" value="1">
                                        
                                </div>
                                <div class="relative">
                                    <label> Đơn giá bán</label>
                                    <input type="text" id='sold_price' oninput="formatNumberS(this)" class="form-control py-3 px-4 w-full lg:w-64 box pr-10" value="0">
...
$('#btnstore').on( "click", function() {
    ...
    importDoc = new ImportDoc(0,final_amount, wh_id,product_id,quantity);
    ...
    $.ajax({
        url: "<?php echo e(route('combocreation.store')); ?>", // Replace with your actual server endpoint URL
        method: "POST",
...
$("#paid_amount").keyup(function(){
    ...
    product_search.autocomplete({
        ...
        select: function(event, ui) {
            $html = "<div style='padding-top:15px'> <b> Sản phẩm: "+ui.item.value+"</b></div>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\shop4\resources\views/backend/combocreations/create.blade.php ENDPATH**/ ?>