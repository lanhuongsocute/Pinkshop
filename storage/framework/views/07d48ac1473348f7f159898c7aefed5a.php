    ...
    <div class="intro-y grid grid-cols-12 gap-5 mt-5">
        ...
        <div class="intro-y col-span-12 lg:col-span-12">
            <div class="lg:flex intro-y">
                <div class="relative">
                    <input type="hidden" name="combo_id" value="<?php echo e($combo->combo_id); ?>"/>
            ...
            <div style='padding-top:15px'> <span> Sản phẩm: <?php echo e($combo->title); ?></span></div>
            </div>
            <input type="hidden" id='product_id'  name="product_id" value = "<?php echo e($combo->id); ?>">
...
<script src="<?php echo e(asset('backend/assets/js/product_combo.js')); ?>"></script> 
...
$(document).ready(function(){ //Your code here 
    $.ajax({
        type: 'GET',
        url: '<?php echo e(route("combo.getProductList")); ?>',
        data: {
           combo_id: <?php echo e($combo->combo_id); ?>,
...
$('#btnstore').on( "click", function() {
    ...
    importDoc = new ImportDoc(<?php echo e($combo->combo_id); ?>,product_id,final_amount );
    ...
    $.ajax({
        url: "<?php echo e(route('combo.update',$combo->id)); ?>", // Replace with your actual server endpoint URL
        method: "PATCH",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\shop4\resources\views/backend/combos/edit.blade.php ENDPATH**/ ?>