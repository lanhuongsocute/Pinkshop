                    ...
                    <div class="col-span-12 lg:col-span-4">
                        <div class="intro-y box mt-3  py-3 px-3 ">
                            ...
                            <div class=" mt-3 ">
                                ...
                                <div class="flex">
                                    <input type="text" id='customer_search' value="<?php echo e(\App\Models\User::where('id',$warehouseout->customer_id)->value('full_name')); ?>"
                        ...
                        <div class="intro-y box mt-3  py-3 px-3">
                            ...
                            <div class="mt-3"> 
                                ...
                                <input type="number" id='discount_amount'  value="<?php echo e($warehouseout->discount_amount); ?>"
...
<script src="<?php echo e(asset('backend/assets/js/product_selling4.js')); ?>"></script> 
...
$(document).ready(function(){ //Your code here 
    $.ajax({
        type: 'GET',
        url: '<?php echo e(route("warehouseout.getProductList")); ?>',
        data: {
        ...
        success: function(data) {
            ...
            products.forEach((pitem) => {
                ...
                newpro = new Product(pitem.id,pitem.title, pitem.price,pitem.price_in,pitem.price_out,pitem.type,pitem.quantity,pitem.stock_qty +  pitem.quantity,imageurls[0],pitem.seri,pitem.series,plist);
...
$('#btnstore').on( "click", function() {
    ...
    $.ajax({
        url: "<?php echo e(route('warehouseout.update',$warehouseout->id)); ?>", // Replace with your actual server endpoint URL
        method: "POST",
        ...
        select: function(event, ui) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    const newProduct = 
                    new Product(ui.item.id,ui.item.value, ui.item.price, ui.item.price_in, ui.item.price_out, ui.item.type, 1,ui.item.qty, ui.item.imgurl,'',data.series,plist);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\shop4\resources\views/backend/warehouseouts/edit.blade.php ENDPATH**/ ?>