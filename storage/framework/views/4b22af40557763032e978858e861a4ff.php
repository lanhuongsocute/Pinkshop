                ...
                <div class="intro-y grid grid-cols-12 gap-5 mt-5">
                    ...
                    <div class="col-span-12 lg:col-span-4">
                        ...
                        <div style="display:none" class="intro-y box mt-3  py-3 px-3 ">
                            <div class="mt-3 ">
                                <input type="hidden" id='shipcost'  value="<?php echo e($ship_amount); ?>"
...
<script src="<?php echo e(asset('backend/assets/js/product_returndetail.js')); ?>"></script> 
...
$(document).ready(function(){ //Your code here 
    $.ajax({
        type: 'GET',
        url: '<?php echo e(route("warehouseout.getProductListReturn")); ?>',
        data: {
            wo_id: <?php echo e($warehouseout->id); ?>,
            woold_id: <?php echo e($warehouseoutreturn->id); ?>,
        ...
        success: function(data) {
            ...
            products.forEach((pitem) => {
                ...
                newpro = new Product(pitem.id,pitem.title, pitem.price,pitem.type,pitem.qty,pitem.quantity -pitem.qty_returned +  pitem.qty,imageurls[0],pitem.seri,pitem.series,plist);
...
$('#btnstore').on( "click", function() {
    ...
    $.ajax({
        url: "<?php echo e(route('warehouseout.updatereturndetail',$warehouseout->id)); ?>", // Replace with your actual server endpoint URL
        method: "POST",
        ...
        success: function(response) {
            ...
            if(response.status == true)
            {
                ...
                // updateListView();
                window.location.href = '<?php echo e(route("warehouseout.index")); ?>';
                return;
            }
            else
            {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\shop4\resources\views/backend/warehouseouts/editreturn.blade.php ENDPATH**/ ?>