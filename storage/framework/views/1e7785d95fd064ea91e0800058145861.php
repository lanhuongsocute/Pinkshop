                    ...
                    <form action="<?php echo e(route('report.sanpham')); ?>" method = "get" class="xl:flex sm:mr-auto" >
                        ...
                        <div class="sm:flex items-center sm:mr-4">
                            ...
                            <select name="cat_id" id="tabulator-html-filter-field" class="form-select w-full sm:w-32 2xl:w-full mt-2 sm:mt-0 sm:w-auto">
                                <option value="0" <?php echo e($order_type == "asc"?"selected":""); ?>>Chọn danh mục</option>
                                <?php $__currentLoopData = $cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($cat->id); ?>" <?php echo e($cat->id == $cat_id?"selected":""); ?>><?php echo e($cat->title); ?></option>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\shop4\resources\views/backend/reports/sanpham.blade.php ENDPATH**/ ?>