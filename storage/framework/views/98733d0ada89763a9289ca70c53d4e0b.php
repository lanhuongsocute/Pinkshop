...
<div class="content">
    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                    <h2 class="text-lg font-medium mr-auto">
                        Chuyển tiền người dùng: <?php echo e(\App\Models\User::where('id',$supplier->id)->value('full_name')); ?>
    ...
    <div class="grid grid-cols-12 gap-12 mt-5">
        <div class="intro-y col-span-12 lg:col-span-12">
            <!-- BEGIN: Form Layout -->
            <form method="post" action="<?php echo e(route('user.savestoretouser')); ?>" id ="myform">
                <?php echo csrf_field(); ?>
                <div class="intro-y box p-5">
                    ...
                    <div>
                        ...
                        <input id="paid_amount" name="paid_amount" value = "<?php echo e(number_format($supplier->budget  ,0,'.',',')); ?> "
                        ...
                        <div class="flex flex-col sm:flex-row items-center">
                            ...
                            <select name="bank_id" class="form-select mt-2 sm:mr-2"   >
                                <?php $__currentLoopData = $bankaccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bank): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value ="<?php echo e($bank->id); ?>"><?php echo e($bank->title); ?> (sẵn có: <?php echo e(Number_format($bank->total,0,'.',',')); ?>)</option>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\shop4\resources\views/backend/users/storetouser.blade.php ENDPATH**/ ?>